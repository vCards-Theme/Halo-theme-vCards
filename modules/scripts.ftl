        ...
        <div class="tags">
            <ul class="tags-list" style="padding: unset;">
                <@tagTag method="list">
                    <#list tags as tag>
                        <li class="mdui-chip">
                            <a class="mdui-chip-title" href="${tag.fullPath!}" title='${tag.name!}'>
                                ${tag.name!}
                            </a>
                        </li>
                    </#list>
...
<script src="${theme_base!}/assets/js/jquery-3.4.1.min.js"></script>
<script src="${theme_base!}/assets/js/plugins.min.js"></script>
<script src="${theme_base!}/assets/js/common.js"></script>
