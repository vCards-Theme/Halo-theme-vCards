    ...
    <div class="box box-content">
        ...
        <div class="select">
            ...
            <ul class="filter">
                ...
                <li class="filter__item active" data-filter="*"><a class="filter__link active" href="#filter">全部</a>
                </li>
                <li class="filter__item" data-filter=".category-'.$this->title.'"><a class="filter__link"
                                                                                     href="#filter">生活</a></li>
                <li class="filter__item" data-filter=".category-'.$this->title.'"><a class="filter__link"
                                                                                     href="#filter">旅游</a></li>
                <li class="filter__item" data-filter=".category-'.$this->title.'"><a class="filter__link"
        ...
        <div class="gallery-grid gallery-grid-two js-grid js-filter-container">
            ...
            <figure class="gallery-grid__item">
                <div class="gallery-grid__image-wrap">
                    <img class="gallery-grid__image cover lazyload" ${1}src="${2}"${3} data-zoom
                         alt="'.$this->title.'"/>
                </div>
